...
namespace tea.Areas.Mis.Controllers
{
    ...
    public class MSYSP002_ProgramController : BaseController
    {
        ...
        public ActionResult Index(int page = 1, string searchText = "")
        {
            ...
            {
                var modelData = repos.GetDapperDataListAll(searchText);
            ...
            using (z_repoPrograms repos = new z_repoPrograms())
            {
                ...
                if (model == null)
                {
                    ...
                    using (AttributeService attr = new AttributeService())
                    {
                        ...
                        model.IsPageSize = (bool)attr.GetDefaultValue<z_metaPrograms>("IsPageSize");
                        model.IsSearch = (bool)attr.GetDefaultValue<z_metaPrograms>("IsSearch");
