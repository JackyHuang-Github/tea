...
";
    ...
    public void SetDefaultCompany()
    {
        ...
        AppService.CompanyAddress = "";
        AppService.CompanyTelphone = "";
        AppService.CompanyEmail = "";
        ...
        if (model != null)
        {
            ...
            AppService.CompanyAddress = model.CompAddress;
            AppService.CompanyTelphone = model.CompTel;
            AppService.CompanyEmail = model.ContactEmail;
