...
public class z_repoApplications : BaseClass
{
    ...
    {
        string str_query = @"
SELECT Id,IsEnabled,IsDebug,AppName,AdminName,ShopName,AppVersion,EncryptionMode,PowerBy,LanguageNo 
...
";
    ...
    public void SetDefaultApplication()
    {
        ...
        if (model != null)
        {
            ...
            AppService.AdminName = model.AdminName;
            AppService.ShopName = model.ShopName;
