...
public partial class CodeGenerator : CodeBase
{
    ...
    public string GetControllerClass(vmControllerModel model)
    {
        ...
        str_value += "        public ActionResult Index(int page = 1, string searchText = \"\")" + EndCode;
        str_value += "        {" + EndCode;
        ...
        str_value += "            {" + EndCode;
        str_value += "                var modelData = repos.GetDapperDataList(searchText);" + EndCode;
        str_value += "                var model = modelData.ToPagedList(page, PrgService.PageSize);" + EndCode;
        str_value += "                ViewBag.SearchText = searchText;" + EndCode;
        str_value += "                ViewBag.PageInfo = PrgService.SetIndex(model.PageNumber, model.PageCount, searchText);" + EndCode;
